import React, { useCallback, useState, useRef, ChangeEvent, MouseEvent, DragEvent, FormEvent } from 'react';
...
declare global {
  namespace React {
    interface InputHTMLAttributes<T> {
      // Fix: Changed property to lowercase 'webkitdirectory' to align with the HTML attribute spec.
    ...
    >
      ...
      />
       <input
        ...
        className="hidden"
        multiple
        // Fix: Use 'webkitdirectory' (lowercase) as a boolean attribute to fix the TS error.
        webkitdirectory
        onChange={handleFileChange}
        disabled={isProcessing}
      />
