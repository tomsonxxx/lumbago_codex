...
**Pełny master planów + checklist + Faza0-5 + Downloader/AI + matrix:** `docs/PLAN_MASTER_CONSOLIDATED_2026-07-14.md` (konsolidacja 2026-07-14). Ten plik zawiera proceduralne kroki + portable/DL notes (aktualizuj identycznie).
