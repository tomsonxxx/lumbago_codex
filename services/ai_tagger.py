...
_MUSIC_ARCHIVIST_SYSTEM_PROMPT = (
    ...
    "10. GENRE: Be as specific as possible. Use detailed subgenres instead of broad categories.\n"
    "    Examples: 'Deep House', 'Tech House', 'Liquid Drum & Bass', 'Future Garage',\n"
    "    'Melodic Techno', 'UK Garage', 'Jungle', 'Hard Techno', 'Atmospheric DnB' etc.\n"
    "    Avoid generic terms like 'Electronic', 'Dance', 'Rock' if a more precise style applies.\n"
    "11. Latin alphabet only in all text fields.\n\n"
...
class DatabaseTagger:
    ...
    def _resolve_mbid_via_acoustid(self, track: Track) -> str | None:
        if not self._acoustid:
            return None
        try:
            from services.recognizer import AcoustIdRecognizer  # local import avoids circular
