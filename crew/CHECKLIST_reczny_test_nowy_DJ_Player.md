...
**2026-06-15 dalszy 'dalej' (dadalej / additional label polish per "dadalej"):** Row labels now include match_method from staged groups (fingerprint/fuzzy_tags/hash_exact visible e.g. "Grupa 1 (sim 0.97, fingerprint)"). UI transparency for the 3-method. Per SZPIEG... must document identical. Verifs + push. 'Gotowe' micro. Nie przestawaj.
