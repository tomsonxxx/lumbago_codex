...
from ui.change_history_dialog import ChangeHistoryDialog
from ui.duplicates_dialog import DuplicatesDialog
from ui.models import TrackGridDelegate, TrackTableModel
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_sidebar(self) -> QtWidgets.QFrame:
        ...
        self.btn_ai = AnimatedButton("Autotagowanie teraz")
        self.btn_ai.setToolTip("Jednym kliknięciem: analiza, pobranie, walidacja i zapis tagów")
        ...
        self.btn_process_log = AnimatedButton("Log procesów")
        self.btn_process_log.setToolTip("Pokaż log procesów aplikacji")
